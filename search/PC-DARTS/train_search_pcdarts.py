...
from concate_sum_five_sig_pc import Network
...
parser.add_argument('--alphas_suffix',type=str,default='-pcdarts')
...
def main():
  ...
  for epoch in range(args.epochs):
    ...
    # training
    train_acc, train_obj = train(train_queue, valid_queue, model, p_optimizer, criterion, w_optimizer, lr,scheduler, epoch)
...
def train(train_queue, valid_queue, model, p_optimizer, criterion, w_optimizer, lr, scheduler, epoch):
