...
from concate_sum_five_gaea_sig import Network
from architect_gaea import Architect
...
parser.add_argument('--alphas_suffix',type=str,default='-gaea-erm')
parser.add_argument('--bilevel', default=False, action='store_false', help='Bool type')
...
def main():
  ...
  for epoch in range(args.epochs):
    ...
    # training
    train_acc, train_obj = train(train_queue, model, architect, criterion, optimizer, lr,scheduler)
...
def train(train_queue, model, architect, criterion, optimizer, lr,scheduler):
