...
from concate_sum_five_sig_gdas import Network
...
parser.add_argument('--alphas_suffix',type=str,default='-gdas')
...
def main():
  ...
  for epoch in range(args.epochs):
    ...
    logging.info('epoch %d lr %e tau %e', epoch, lr, model.get_tau())
