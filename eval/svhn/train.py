...
parser.add_argument('--dataset', type=str, default='svhn', help='choose dataset')
...
def main():
  ...
  for epoch in range(args.epochs):
    ...
    if epoch>400:
        ...
        if train_acc>99: args.drop_path_prob+=0.0001
    else: 
        if train_acc>97: args.drop_path_prob+=0.0005
